...
class _DoctorMapScreenState extends State<DoctorMapScreen> {
  ...
  void initState() {
    ...
    doctorLatitude = arguments['doctorLatitude'];
    doctorLongitude = arguments['doctorLongitude'];
  }
  ...
  Widget build(BuildContext context) {
    ...
    final double doctorLatitude = arguments['doctorLatitude']!;
    final double doctorLongitude = arguments['doctorLongitude']!;
                ...
                MarkerLayer(
                  markers: [
                    ...
                    Marker(
                      width: 40.0,
                      height: 40.0,
                      point: LatLng(doctorLatitude, doctorLongitude),
                      builder: (ctx) => const Icon(
                        Icons.location_on,
                        color: Colors.red,
                      ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8.0),
                FutureBuilder<String>(
                  future: getAddressFromCoordinates(doctorLatitude, doctorLongitude),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      return Text(
                        snapshot.data!,
