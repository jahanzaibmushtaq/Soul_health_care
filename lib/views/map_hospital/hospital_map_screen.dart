...
class _HospitalMapScreenState extends State<HospitalMapScreen> {
  ...
  void initState() {
    ...
    hospitalLatitude = arguments['hospitalLatitude'];
    hospitalLongitude = arguments['hospitalLongitude'];
  }
  ...
  Widget build(BuildContext context) {
    ...
    final double hospitalLatitude = arguments['hospitalLatitude']!;
    final double hospitalLongitude = arguments['hospitalLongitude']!;
                ...
                MarkerLayer(
                  markers: [
                    ...
                    Marker(
                      width: 40.0,
                      height: 40.0,
                      point: LatLng(hospitalLatitude, hospitalLongitude),
                      builder: (ctx) => const Icon(
                        Icons.location_on,
                        color: Colors.red,
                      ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8.0),
                FutureBuilder<String>(
                  future: getAddressFromCoordinates(hospitalLatitude, hospitalLongitude),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      return Text(
                        snapshot.data!,
