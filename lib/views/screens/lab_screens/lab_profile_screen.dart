...
class LabProfileScreen extends StatefulWidget {
  const LabProfileScreen({Key? key}) : super(key: key);
...
class _LabProfileScreenState extends State<LabProfileScreen> {
  ...
  void onNext() {
    if (_userProfileController.selectedRole == 'Lab') {
      if (_formKey.currentState!.validate()) {
        _userProfileController.labModel.value = LabModel(
      ...
      else if (_userProfileController.selectedRole == 'Hospital') {
        if (_formKey.currentState!.validate()) {
          _userProfileController.hospitalModel.value = HospitalModel(
              age: _userProfileController.ageEditingController.text,
              name: _userProfileController.nameEditingController.text,
              category: _userProfileController.selectedRole.value,
              address: _userProfileController.selectedRole.value,
              isVerified: false,
              phoneNumber: _userProfileController.phoneEditingController.text,
              gender: _userProfileController.selectGender == Gender.male
                  ? "male"
        ...
        else if (_userProfileController.selectedRole == 'Pharmacy') {
          if (_formKey.currentState!.validate()) {
            ...
            if (_formKey.currentState!.validate()) {
              _userProfileController.doctorModel.value = DoctorModel(
                  ...
                  isVerified: false,
                  phoneNumber: _userProfileController.phoneEditingController
                      .text,
                  gender: _userProfileController.selectGender == Gender.male
                      ? "male"
                      : _userProfileController.selectGender == Gender.female
